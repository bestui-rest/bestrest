...
public class HttpClientUtil {
    ...
    public static String doGet(String url, String token) {
        ...
        httpGet.setHeader("Content-type","application/x-www-form-urlencoded; charset=GBK");
        httpGet.setHeader("Accept", "text/html; charset=GBK");
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(ht.doGet("http://localhost:8080/Test/newfile.do?name=张三", ""));
	}
}